        ...
        <div class="modal-content" style="max-width: 600px;">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="company-mobile" placeholder="+91 9876543210">
                </div>
                    ...
                    <tr>
                        <td class="label">
                            ...
                            <div
                                ...
                                <input type="text" id="custName" oninput="handleRegularCustomerSearch()"
                ...
                <table class="bill-footer">
                    <tbody>
                        <tr>
                            ...
                            <td class="align-center" colspan="2">
                                <p id="bill-company-signatory">for SHREE BALAJI PLY AND HARDWARE</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
