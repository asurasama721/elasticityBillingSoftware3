...
#dimensionInputs input[type="checkbox"] {
    flex: none;
}
...
/* ============================================================
   IMAGE GENERATION STYLES (.pdf-mode)
   These styles apply ONLY when generating the Bill Image
   ============================================================ */

/* 1. Base Setup for Image Capture */
body.pdf-mode {
    background: white !important;
    margin: 0 !important;
    padding: 0 !important;
    ...
    overflow: hidden !important; /* Prevent scrollbars in image */
}

/* 2. Force Bill Containers to A4 Width (matches PDF) */
.pdf-mode #bill-container, 
.pdf-mode #gst-bill-container {
...
.pdf-mode #tools,
.pdf-mode #settings-sidebar,
.pdf-mode #settings-overlay,
.pdf-mode #manual-item-container,
.pdf-mode .modal,
.pdf-mode .notification-container,
.pdf-mode #reg-footer-btn,
.pdf-mode .add-payment-form,
.pdf-mode .payment-dialog,
.pdf-mode .ledger-dialog,
.pdf-mode #share-modal,
.pdf-mode .btn-share,
.pdf-mode .action-menu-container, /* Hide 3-dot menus */
.pdf-mode .icon-btn,              /* Hide small icons */
.pdf-mode button {                /* Hide all buttons */
    display: none !important;
}

/* 5. Input Cleaning (Remove borders from inputs for clean look) */
/* .pdf-mode input,
.pdf-mode textarea,
.pdf-mode select {
    border: none !important;
...
.history-item {
    position: relative;
    /* For absolute positioning of remove button */
    display: flex;
    flex-direction: column;
    gap: 4px;
    padding: 12px 15px;
...
/* Shared Sort Button Animation - Updated with Vendor IDs */
#saved-bills-sort-btn .material-icons,
#customer-sort-btn .material-icons,
#vendor-sort-btn .material-icons,
#vendor-bills-sort-btn .material-icons {
    transition: transform 0.3s ease;
}

#saved-bills-sort-btn.ascending .material-icons,
#customer-sort-btn.ascending .material-icons,
#vendor-sort-btn.ascending .material-icons,
#vendor-bills-sort-btn.ascending .material-icons {
    transform: scaleY(-1);
}

/* for print button*/
@media print {
    /* 1. RESET PAGE MARGINS (Crucial for blank page fix) */
    @page {
       
        size: auto;
    }

    /* 2. RESET BODY HEIGHT & OVERFLOW */
    html, body {
        height: auto !important;
        min-height: 0 !important; /* Fixes the 100vh issue */
        margin: 0 !important;
        padding: 0 !important;
        overflow: hidden !important; /* Cuts off any 1px spillover */
        background-color: #ffffff !important;
    }

    /* 3. CLEAN UP MAIN CONTAINER */
    #main-container {
        width: 100% !important;
        height: auto !important;
        margin: 0 !important;
